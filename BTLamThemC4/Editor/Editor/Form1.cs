    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            foreach (FontFamily family in fonts.Families)
                listBox.Items.Add(family.Name); //Add font vao listBox 
            FontSize(); //Hàm tạo size chữ 
        }

        private void FontSize()//size chữ
        {
            for (int i = 8; i <= 32; i += 2)  //comboBox mặc đinh tính từ 0 
                comboBox.Items.Add(i.ToString()); //comboBox mặc đinh tính từ 0 
